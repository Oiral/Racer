...
////// Specular:
                ...
                float3 node_5692 = ((node_8885.r*node_1704.rgb + node_8885.g*_node_1704_copy.rgb + node_8885.b*_node_1704_copy_copy.rgb)*_Tint.rgb);
                float3 diffuseColor = node_5692; // Need this for specular when using metallic
